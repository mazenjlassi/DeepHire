package org.example.deephire.RestController;

import org.example.deephire.Service.CertificationService;
    ...
    public ResponseEntity<Certification> update(@PathVariable Long id, @RequestBody Certification certification) {
        try {
            ...
            if (existingCertification != null) {
                certification.setId(id); // Ensure the ID is set for the update
